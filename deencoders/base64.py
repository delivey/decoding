decode = input("Enter base64 string: ") # Asks the user to input the base64 string to decode

### TODO: Change it to accept arguments instead
...
conct = ""
for char in decode: # For each character in the inputted text
